...
public class EmpDao {
    ...
    public int update(Emp p) {
        String sql = "update emp_table set name='" + p.getName() + "', salary=" + p.getSalary() + ",designation='" + p.getDesignation() + "' where id=" + p.getId() + "";
        return template.update(sql);
    }
    ...
    public List<Emp> getEmployees() {
        return template.query("select * from emp_table", new RowMapper<Emp>() {
